            ...
            <div class="col-9">
                <nav aria-label="Breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="../categoria-producto/laptops.html" style="text-decoration: none; color: #666;">Lenovo IdeaPad 3i
</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Lenovo IdeaPad 3i
</li>
                    </ol>
                </nav>
                ...
                <div class="row ">
                    ...
                    <div id="rowProductoAgregado" class="row mt-3 d-none">
                        <div class="col">
                            <div class="alert alert-primary" role="alert">
                                “Lenovo IdeaPad 3i” se ha añadido a tu carrito.
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/Lenovo_FN.png')">
                                    <img src="../assets/img/3_productos/Lenovo_FN.png" alt="Imagen 1" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/Lenovo1_FN-600x600.png')">
                                    <img src="../assets/img/3_productos/Lenovo1_FN-600x600.png" alt="Imagen 2" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/Lenovo3_FN-600x600.png')">
                                    <img src="../assets/img/3_productos/Lenovo3_FN-600x600.png" alt="Imagen 3" class="img-fluid">
                                </div>
                            </div>
                        </div> <!--row-->
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <h1 class="product-title">Lenovo IdeaPad 3i
</h1>
                        <p class="price" style="color: #2EA3F2; font-size: 32px;">$359,00</p>
                        <div class="product-description" style="color: #666;">
                            <ul>
                                <li><strong>Marca:</strong> LENOVO</li>
                                <li><strong>Modelo:</strong> IdeaPad</li>
                                <li><strong>Procesador:</strong> Intel Core i3-1115G4</li>
                                <li><strong>Tamaño de pantalla:</strong> 15.6 Pulgadas</li>
                                <li><strong>Almacenamiento:</strong>  PCIe M.2 de 256 GB</li>
                        ...
                        <form class="cart" id="productForm" action="#" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                $precio_por_producto = 359; // Precio por cada producto
                                $ruta_img = '../assets/img/productos/Lenovo_FN-300x300.png'; // Ruta de la imagen del producto
                                $producto = 'Lenovo IdeaPad 3i'; // Nombre del producto
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="tab-content" id="product-tabs-content">
                            <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                                <h2>Descripción</h2>
                                <ul>
                                    <li>RAM de alta velocidad y espacio enorme: 12 GB de RAM DDR4 para ejecutar sin problemas múltiples aplicaciones y pestañas del navegador a la vez; la unidad de estado sólido PCIe M.2 de 256 GB permite un arranque rápido y transferencia de datos</li>
                                    <li>Procesador: procesador Intel Core i3-1115G4 de 3.00 GHz de 2 núcleos (caché de 6 MB, hasta 4.10 GHz), gráficos Intel UHD
Pantalla deslumbrante: pantalla táctil HD de 15.6 pulgadas con biseles estrechos</li>
                                    <li>Especificaciones técnicas: 2 USB tipo A, 1 USB 2.0 tipo A, 1 HDMI, 1 combo de auriculares/micrófono; lector de tarjetas SD; Wi-Fi 6<li>Especificaciones técnicas: 2 USB 3.0 tipo A, 1 USB 2.0 tipo A, 1 HDMI, 1 RJ-45, 1
                                        combo de auriculares/micrófono; Wi-Fi 6; Bluetooth 5</li>
                                        <li>Sistema operativo: Windows 11 Home-Beautiful, nuevo diseño más consistente, excelentes opciones de diseño de ventana, mejor funcionalidad de varios monitores, características de rendimiento mejoradas, nueva selección y capacidades de videojuegos, compatible con aplicaciones de Android</li>
                                </ul>
                            </div>
    ...
    <script>
        ...
        function cargarImagenPorDefecto() {
            ...
            imagenPorDefecto.src = '../assets/img/3_productos/Lenovo_FN.png'; // Ruta de la imagen por defecto
            imagenPorDefecto.onload = function() {
                ctx.drawImage(imagenPorDefecto, 0, 0, canvas.width, canvas.height);
                imagenActual = '../assets/img/3_productos/Lenovo_FN.png'; // Actualiza la ruta de la imagen actual
            };
        }
    </script>

...
<head>
    ...
    <title>Dell XPS 13 931 | Online Dc Solution</title>
...
<body style="background-color: #f6f7fb" onload="cargarImagenPorDefecto()">
            ...
            <div class="col-9">
                <nav aria-label="Breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Dell XPS 13 931</li>
                    </ol>
                </nav>
                ...
                <div class="row ">
                    ...
                    <div id="rowProductoAgregado" class="row mt-3 d-none">
                        <div class="col">
                            <div class="alert alert-primary" role="alert">
                                “Dell XPS 13 931” se ha añadido a tu carrito.
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/Dell_XP_1_F-e1704333164768.png')">
                                    <img src="../assets/img/3_productos/Dell_XP_1_F-e1704333164768.png" alt="Imagen 1" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/3.Dell_XPS2_F-600x425.png')">
                                    <img src="../assets/img/3_productos/3.Dell_XPS2_F-600x425.png" alt="Imagen 2" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/3.Dell_XPS1_F.png')">
                                    <img src="../assets/img/3_productos/3.Dell_XPS1_F.png" alt="Imagen 3" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/3.Dell_XPS3_F-600x338.png')">
                                    <img src="../assets/img/3_productos/3.Dell_XPS3_F-600x338.png" alt="Imagen 3" class="img-fluid">
                                </div>
                            </div>
                        </div> <!--row-->
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <h1 class="product-title">Dell XPS 13 931</h1>
                        <p class="price" style="color: #2EA3F2; font-size: 32px;">$1.300,00</p>
                        <div class="product-description" style="color: #666;">
                            <ul>
                                <li><strong>Marca:</strong> Dell</li>
                                <li><strong>Modelo:</strong> Dell XPS 13 9310</li>
                                <li><strong>Procesador:</strong> Intel Core i7-1185G7</li>
                                <li><strong>Tamaño de pantalla:</strong>13,4 Pulgadas</li>
                                <li><strong>Almacenamiento:</strong> 512 GB M.2 PCIe NVMe</li>
                        ...
                        <form class="cart" id="productForm" action="#" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                $precio_por_producto = 1300; // Precio por cada producto
                                $ruta_img = '../assets/img/productos/Dell_XP_1_F-e1704333164768-300x300.png'; // Ruta de la imagen del producto
                                $producto = 'Dell XPS 13 931'; // Nombre del producto
                                $marca = 'Dell'; // Marca del producto
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="tab-content" id="product-tabs-content">
                            <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                                <h2>Descripción</h2>
                                <ul>
                                    <li>Pantalla OLED 3.5K (3456x2160) InfinityEdge Touch antirreflectante de 400 Nit de 13.4 pulgadas</li>
                                    <li>Procesador Intel Core i7-1195G7 de 11ª generación (caché de 12 MB, hasta 5.0 GHz)
                                    </li>
                                    <li>Memoria LPDDR4x integrada de 16 GB, 4267 MHz; unidad de estado sólido M.2 PCIe NVMe de 512 GB
                                    <li>Killer Wi-Fi 6 AX1650 (2 x 2) y Bluetooth 5.1</li>
                                    <li>Fabricación de precisión: el 100 % del chasis se ha esculpido mediante un proceso de mecanizado CNC (control numérico del equipo).</li>
                                    <li>Frío y ligero: para el reposamuñecas negro, la fibra de carbono tejida inspirada en el sector aeroespacial, o el reposamuñecas de fibra de vidrio tejida blanco Ártico, permiten obtener la máxima resistencia y el mínimo peso.</li>
                                </ul>
                            </div>
    ...
    <script>
        ...
        function cargarImagenPorDefecto() {
            ...
            imagenPorDefecto.src = '../assets/img/3_productos/Dell_XP_1_F-e1704333164768.png'; // Ruta de la imagen por defecto
            imagenPorDefecto.onload = function() {
                ctx.drawImage(imagenPorDefecto, 0, 0, canvas.width, canvas.height);
                imagenActual = '../assets/img/3_productos/Dell_XP_1_F-e1704333164768.png'; // Actualiza la ruta de la imagen actual
            };
        }
    </script>

...
<head>
    ...
    <title>Laptop Acer 2023 Predator Helios 300| Online Dc Solution</title>
...
<body style="background-color: #f6f7fb" onload="cargarImagenPorDefecto()">
            ...
            <div class="col-9">
                <nav aria-label="Breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Laptop Acer 2023 Predator Helios 300</li>
                    </ol>
                </nav>
                ...
                <div class="row ">
                    ...
                    <div id="rowProductoAgregado" class="row mt-3 d-none">
                        <div class="col">
                            <div class="alert alert-primary" role="alert">
                                “Laptop Acer 2023 Predator Helios 300” se ha añadido a tu carrito.
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/4.Laptop_Acer_F-e1704342323847.png')">
                                    <img src="../assets/img/3_productos/4.Laptop_Acer_F-e1704342323847.png" alt="Imagen 1" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/4.Laptop_Acer1_F-600x384.png')">
                                    <img src="../assets/img/3_productos/4.Laptop_Acer1_F-600x384.png" alt="Imagen 2" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/4.Laptop_Acer2_F-600x390.png')">
                                    <img src="../assets/img/3_productos/4.Laptop_Acer2_F-600x390.png" alt="Imagen 3" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/4.Laptop_Acer3_F-600x355.png')">
                                    <img src="../assets/img/3_productos/4.Laptop_Acer3_F-600x355.png" alt="Imagen 3" class="img-fluid">
                                </div>
                            </div>
                        </div> <!--row-->
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <h1 class="product-title">Laptop Acer 2023 Predator Helios 300</h1>
                        <p class="price" style="color: #2EA3F2; font-size: 32px;">$1.999,00</p>
                        <div class="product-description" style="color: #666;">
                            <ul>
                                <li><strong>Marca:</strong> Acer</li>
                                <li><strong>Modelo:</strong> Acer 2023 Predator Helios 300</li>
                                <li><strong>Procesador:</strong> Intel Core i7-1185G7</li>
                                <li><strong>Tamaño de pantalla:</strong>15,6 Pulgadas</li>
                                <li><strong>Almacenamiento:</strong>2 TB SSD NVMe</li>
                                <li><strong>Memoria RAM:</strong> 32 GB</li>
                                <li><strong>Color:</strong> Negro</li>
                                <li><strong>Sistema operativo:</strong> Windows 11</li>
                                <li><strong>Descripción de la tarjeta gráfica:</strong> NVIDIA GeForce RTX 3070 Ti 8GB</li>
                            </ul>
                        </div>
                        <p class="stock in-stock" style="color: #b3af54;">5 disponibles</p>
                        <form class="cart" id="productForm" action="#" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                $precio_por_producto = 1999; // Precio por cada producto
                                $ruta_img = '../assets/img/productos/4.Laptop_Acer_F-e1704342323847-300x300.png'; // Ruta de la imagen del producto
                                $producto = 'Laptop Acer 2023 Predator Helios 300'; // Nombre del producto
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="tab-content" id="product-tabs-content">
                            <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                                <h2>Descripción</h2>
                                <ul>
                                    <li>NVIDIA GeForce RTX 3070 Ti 8GB: la última NVIDIA GeForce RTX 3070 Ti (8 GB dedicado GDDR6 VRAM) está alimentado por una arquitectura galardonada con nuevos núcleos de trazado de rayos, núcleos tensor y multiprocesadores de transmisión compatibles con DirectX 12 Ultimate para el mejor rendimiento de juego<li>Procesador Intel Core i7-1195G7 de 11ª generación (caché de 12 MB, hasta 5.0 GHz)
                                    </li>
                                    <li>Pantalla QHD de 240 Hz de 15.6 pulgadas: pantalla LED de frecuencia de actualización de 240 Hz 2K Quad HD (2560 x 1440) de 240 Hz. Teclado retroiluminado RGB. Cámara web Full HD de 1080p. Wi-Fi 6E AX1675, Bluetooth 5.2, HDMI 2.1, Thunderbolt 4, RJ-45<li>Killer Wi-Fi 6 AX1650 (2 x 2) y Bluetooth 5.1</li>
                                    <li>Intel Core i7-12700H de 12ª generación: procesador Intel Core i7-12700H de 12ª generación de 2.70 GHz (hasta 4.7 GHz, caché de 24 MB, 14 núcleos, 20 hilos, 6 núcleos de rendimiento); gráficos dedicados GeForce RTX 3070 Ti 8GB GDDR6<li>Frío y ligero: para el reposamuñecas negro, la fibra de carbono tejida inspirada en el sector aeroespacial, o el reposamuñecas de fibra de vidrio tejida blanco Ártico, permiten obtener la máxima resistencia y el mínimo peso.</li>
                                    <li>Ampliado a 32 GB DDR5 4800 MHz RAM La memoria de doble canal aumenta significativamente el rendimiento, en comparación con un solo canal, y el estándar de memoria DDR5 de próxima generación de 4800 MHz permite que TUF Dash realice múltiples tareas con facilidad</li>
                                    <li>Actualizado a SSD NVMe de 2 TB Guarda archivos rápidamente y almacena más datos y juegos. Con enormes cantidades de almacenamiento y potencia de comunicación avanzada, los SSD PCIe son ideales para las principales aplicaciones de juegos, múltiples servidores, copias de seguridad diarias y mucho más</li>
                                </ul>
                            </div>
    ...
    <script>
        ...
        function cargarImagenPorDefecto() {
            ...
            imagenPorDefecto.src = '../assets/img/3_productos/4.Laptop_Acer_F-e1704342323847.png'; // Ruta de la imagen por defecto
            imagenPorDefecto.onload = function() {
                ctx.drawImage(imagenPorDefecto, 0, 0, canvas.width, canvas.height);
                imagenActual = '../assets/img/3_productos/4.Laptop_Acer_F-e1704342323847.png'; // Actualiza la ruta de la imagen actual
            };
        }
    </script>

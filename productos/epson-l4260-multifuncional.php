...
<head>
    ...
    <title>Epson L4260 Multifuncional | Online Dc Solution</title>
...
<body style="background-color: #f6f7fb" onload="cargarImagenPorDefecto()">
            ...
            <div class="col-9">
                <nav aria-label="Breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Epson L4260 Multifuncional</li>
                    </ol>
                </nav>
                ...
                <div class="row ">
                    ...
                    <div id="rowProductoAgregado" class="row mt-3 d-none">
                        <div class="col">
                            <div class="alert alert-primary" role="alert">
                                “Epson L4260 Multifuncional” se ha añadido a tu carrito.
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/L4160.png')">
                                    <img src="../assets/img/3_productos/L4260_FN.png" alt="Imagen 1" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/L42601_FN-600x600.png')">
                                    <img src="../assets/img/3_productos/L42601_FN-600x600.png" alt="Imagen 2" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/L42602_FN-600x600.png')">
                                    <img src="../assets/img/3_productos/L42602_FN-600x600.png" alt="Imagen 3" class="img-fluid">
                                </div>
                            </div>
                        </div> <!--row-->
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <h1 class="product-title">Epson L4260 Multifuncional
</h1>
                        <p class="price" style="color: #2EA3F2; font-size: 32px;">$280,00</p>
    ...
    <script>
        ...
        function cargarImagenPorDefecto() {
            ...
            imagenPorDefecto.src = '../assets/img/3_productos/L4260_FN.png'; // Ruta de la imagen por defecto
            imagenPorDefecto.onload = function() {
                ctx.drawImage(imagenPorDefecto, 0, 0, canvas.width, canvas.height);
                imagenActual = '../assets/img/3_productos/L4260_FN.png'; // Actualiza la ruta de la imagen actual
            };
        }
    </script>

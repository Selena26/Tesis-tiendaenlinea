...
<head>
    ...
    <title>TP-Link AC1200 Gigabit WiFi Router | Online Dc Solution</title>
...
<body style="background-color: #f6f7fb" onload="cargarImagenPorDefecto()">
            ...
            <div class="col-9">
                <nav aria-label="Breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">TP-Link AC1200 Gigabit WiFi Router</li>
                    </ol>
                </nav>
                ...
                <div class="row ">
                    ...
                    <div id="rowProductoAgregado" class="row mt-3 d-none">
                        <div class="col">
                            <div class="alert alert-primary" role="alert">
                                “TP-Link AC1200 Gigabit WiFi Router” se ha añadido a tu carrito.
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/Tp-Link_F.png')">
                                    <img src="../assets/img/3_productos/Tp-Link_F.png" alt="Imagen 1" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/Tp-link1_F.png')">
                                    <img src="../assets/img/3_productos/Tp-link1_F.png" alt="Imagen 2" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/Tp-link2_F.jpg')">
                                    <img src="../assets/img/3_productos/Tp-link2_F.jpg" alt="Imagen 3" class="img-fluid">
                                </div>
                            </div>
                        </div> <!--row-->
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <h1 class="product-title">TP-Link AC1200 Gigabit WiFi Router
                        </h1>
                        <p class="price" style="color: #2EA3F2; font-size: 32px;">$44,99</p>
                        <div class="product-description" style="color: #666;">
                            <ul>
                                <li><strong>Marca: </strong>TP-Link</li>
                                <li><strong>Modelo:</strong>Archer A6 V3                                </li>
                                <li><strong>Frecuencia:</strong> 5 GHz</li>
                                <li><strong>Tecnología de conectividad:</strong> Ethernet, Wifi</li>
                                <li><strong>Estándar de comunicación inalámbrica: </strong>802.11n, 802.11b, 802.11a, 802.11ac, 802.11g</li>
                                <li><strong>Características especiales:</strong> Beamforming, modo invitado, seguridad de Internet, indicador LED, control parental, modo de punto de acceso, QoS, WPSBeamforming, modo invitado, seguridad de Internet, indicador LED, control parental, modo de punto de acceso, QoS, WPS</li>
                                <li><strong>Peso (g):</strong> Aprox. 57 g（incluye receptor）</li>
                                <li><strong>Clase de banda de frecuencia Banda:</strong>Doble</li>
                            </ul>
                        </div>
                        ...
                        <form class="cart" id="productForm" action="#" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                $precio_por_producto = 44.99; // Precio por cada producto
                                $ruta_img = '../assets/img/productos/Tp-link1_F.png'; // Ruta de la imagen del producto
                                $producto = 'TP-Link AC1200 Gigabit WiFi Router'; // Nombre del producto
                                $marca = 'TP-Link'; // Marca del producto
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="tab-content" id="product-tabs-content">
                            <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                                <h2>Descripción</h2>
                                <ul>
                                   <li>El enrutador de doble banda se actualiza a Internet de alta velocidad de 1200 Mbps (300 mbps para 2.4 GHz más 900 Mbps para 5 GHz), lo que reduce el almacenamiento en búfer e ideal para transmisión 4K</li>
                                   <li>Puertos Gigabit completos: enrutador Gigabit con 4 puertos LAN Gigabit, ideal para cualquier plan de Internet y le permite conectar directamente sus dispositivos cableados</li>
                                   <li>Cobertura mejorada: cuatro antenas externas equipadas con tecnología Beamforming amplían y concentran las señales Wi-Fi</li>
                                   <li>Tecnología MU-MIMO: (banda de 5 GHz) permite altas velocidades para múltiples dispositivos simultáneamente</li>
                                   <li>Modo de punto de acceso: admite el modo AP para transformar tu conexión por cable en red inalámbrica, un enrutador inalámbrico ideal para el hogar</li>
                                   <li>Seguridad avanzada con WPA3 - El último protocolo de seguridad Wi-Fi, WPA3, trae nuevas capacidades para mejorar la ciberseguridad en redes personales</li>
                                   <li>TP-Link OneMesh: una forma sencilla de formar una red WiFi con un solo nombre Wi-Fi para una cobertura perfecta en todo el hogar agregando un extensor WiFi OneMesh</li>
                                   <li>Funciona con todos los proveedores de servicios de Internet, como AT&T, Verizon, Xfinity, Spectrum, RCN, Cox, CenturyLink, Frontier, etc. (Se requiere un módem para la mayoría de los proveedores de servicios de Internet)</li>
                                </ul>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    if (empty($_SESSION['cart_quantity'])) {
                        ...
                        echo "<button type='submit' name='eliminar_sesion' class='btn btn-outline-danger'>Eliminar articulo</button>";
                        echo "</form>";
    ...
    <script>
        ...
        function cargarImagenPorDefecto() {
            ...
            imagenPorDefecto.src = '../assets/img/3_productos/Tp-Link_F.png'; // Ruta de la imagen por defecto
            imagenPorDefecto.onload = function() {
                ctx.drawImage(imagenPorDefecto, 0, 0, canvas.width, canvas.height);
                imagenActual = '../assets/img/3_productos/Tp-Link_F.png'; // Actualiza la ruta de la imagen actual
            };
        }
    </script>

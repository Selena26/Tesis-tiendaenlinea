...
<head>
    ...
    <title>Intel Core i7-12700KF | Online Dc Solution</title>
...
<body style="background-color: #f6f7fb" onload="cargarImagenPorDefecto()">
            ...
            <div class="col-9">
                <nav aria-label="Breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Intel Core i7-12700KF</li>
                    </ol>
                </nav>
                ...
                <div class="row ">
                    <div id="rowProductoAgregado" class="row mt-3 d-none">
                        <div class="col">
                            <div class="alert alert-primary" role="alert">
                                “Intel Core i7-12700KF” se ha añadido a tu carrito.
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/corei7.png')">
                                    <img src="../assets/img/3_productos/corei7.png" alt="Imagen 1" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/corei7-.png')">
                                    <img src="../assets/img/3_productos/corei7-.png" alt="Imagen 2" class="img-fluid">
                                </div>
                            </div>
                            <!-- <div class="col-md-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <h1 class="product-title">Intel Core i7-12700KF</h1>
                        ...
                        <div class="product-description" style="color: #666;">
                            <ul>
                                ...
                                <li><strong>Modelo de CPU:</strong> núcleo i7</li>
                                <li><strong>Dimensiones del producto</strong> 4,57 x 1,73 x 3,98 pulgadas</li>
                                ...
                                <li><strong>Velocidad de la CPU:</strong> 3 GHz</li>
    ...
    <script>
        ...
        function cargarImagenPorDefecto() {
            ...
            imagenPorDefecto.src = '../assets/img/3_productos/corei7.png'; // Ruta de la imagen por defecto
            imagenPorDefecto.onload = function() {
                ctx.drawImage(imagenPorDefecto, 0, 0, canvas.width, canvas.height);
                imagenActual = '../assets/img/3_productos/corei7.png'; // Actualiza la ruta de la imagen actual
            };
        }
    </script>

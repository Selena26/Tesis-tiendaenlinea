...
<head>
    ...
    <title>CyberPowerPC Gamer Xtreme VR | Online Dc Solution</title>
...
<body style="background-color: #f6f7fb" onload="cargarImagenPorDefecto()">
            ...
            <div class="col-9">
                <nav aria-label="Breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">CyberPowerPC Gamer Xtreme VR</li>
                    </ol>
                </nav>
                ...
                <div class="row ">
                    ...
                    <div id="rowProductoAgregado" class="row mt-3 d-none">
                        <div class="col">
                            <div class="alert alert-primary" role="alert">
                                “CyberPowerPC Gamer Xtreme VR” se ha añadido a tu carrito.
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/CPUG_FN.png')">
                                    <img src="../assets/img/3_productos/CPUG_FN.png" alt="Imagen 1" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/CPUG1_FN-600x601.png')">
                                    <img src="../assets/img/3_productos/CPUG1_FN-600x601.png" alt="Imagen 2" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/CPUG2_FN-600x599.png')">
                                    <img src="../assets/img/3_productos/CPUG2_FN-600x599.png" alt="Imagen 3" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/CPUG3_FN-600x600.png')">
                                    <img src="../assets/img/3_productos/CPUG3_FN-600x600.png" alt="Imagen 3" class="img-fluid">
                                </div>
                            </div>
                        </div> <!--row-->
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <h1 class="product-title">CyberPowerPC Gamer Xtreme VR</h1>
                        <p class="price" style="color: #2EA3F2; font-size: 32px;">$1.899,00</p>
                        <div class="product-description" style="color: #666;">
                            <ul>
                                <li><strong>Marca:</strong> CyberPowerPC</li>
                                <li><strong>Modelo:</strong> Gamer Xtreme VR</li>
                                <li><strong>Procesador:</strong> Intel Core i9-13900KF</li>
                                <li><strong>Almacenamiento:</strong>SSD PCIe Gen4 NVMe de 1 TB</li>
                                <li><strong>Memoria RAM:</strong> 16 GB</li>
                                <li><strong>Color:</strong> Blanco</li>
                                <li><strong>Sistema operativo:</strong> Windows 11 Home</li>
                                <li><strong>Componentes incluidos: </strong> Torre, teclado, ratón, cable de alimentación</li>
                                <li><strong>Descripción de la tarjeta gráfica:</strong> NVIDIA GeForce RTX 4070 de 12 GB</li>
                            </ul>
                        </div>
                        ...
                        <form class="cart" id="productForm" action="#" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                $precio_por_producto = 1899; // Precio por cada producto
                                $ruta_img = '../assets/img/productos/CPUG_FN-300x300.png'; // Ruta de la imagen del producto
                                $producto = 'CyberPowerPC Gamer Xtreme VR'; // Nombre del producto
                                $marca = 'ACyberPowerPCcer'; // Marca del producto
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="tab-content" id="product-tabs-content">
                            <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                                <h2>Descripción</h2>
                                <ul>
                                    <li>Sistema: Intel Core i9-13900KF 3.0GHz 8+16 núcleos | Chipset Intel Z790 | DDR5 de 16 GB | SSD PCIe Gen4 NVMe de 1 TB | Windows 11 Home original de 64 bits</li>
                                    <li>Gráficos: Tarjeta de video NVIDIA GeForce RTX 4070 de 12 GB | 1 x HDMI | 2 x DisplayPort
                                    </li>
                                    <li>Conectividad: 6 x USB 3.1 | 2 x USB 2.0 | 1x RJ-45 Ethernet de red 10/100/1000 | Wi-Fi 802.11AC | Audio: canal 7.1 | Teclado y ratón
                                    ...
                                    <li>Característica especial: CPU Liquid Cool | Panel lateral de vidrio templado | Iluminación de carcasa RGB personalizada | Ratón para juegos de 7 colores</li>
                                </ul>
                            </div>
    ...
    <script>
        ...
        function cargarImagenPorDefecto() {
            ...
            imagenPorDefecto.src = '../assets/img/3_productos/CPUG3_FN-600x600.png'; // Ruta de la imagen por defecto
            imagenPorDefecto.onload = function() {
                ctx.drawImage(imagenPorDefecto, 0, 0, canvas.width, canvas.height);
                imagenActual = '../assets/img/3_productos/CPUG3_FN-600x600.png'; // Actualiza la ruta de la imagen actual
            };
        }
    </script>

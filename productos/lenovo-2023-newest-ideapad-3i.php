...
<head>
    ...
    <title>Lenovo Newest Ideapad 3i
...
<body style="background-color: #f6f7fb" onload="cargarImagenPorDefecto()">
            ...
            <div class="col-9">
                <nav aria-label="Breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Lenovo Newest Ideapad 3i
                        </li>
                    </ol>
                </nav>
                ...
                <div class="row ">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/Lenovo_FN-1.png')">
                                    <img src="../assets/img/3_productos/Lenovo_FN-1.png" alt="Imagen 1" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/Lenovo2_FN.png')">
                                    <img src="../assets/img/3_productos/Lenovo2_FN.png" alt="Imagen 2" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/Lenovo1_FN-1-600x600.png')">
                                    <img src="../assets/img/3_productos/Lenovo1_FN-1-600x600.png" alt="Imagen 3" class="img-fluid">
                                </div>
                            </div>
                        </div> <!--row-->
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <h1 class="product-title">Lenovo Newest Ideapad 3i</h1>
                        <p class="price" style="color: #2EA3F2; font-size: 32px;">$589,00</p>
                        <div class="product-description" style="color: #666;">
                            <ul>
                                <li><strong>Marca:</strong> Lenovo</li>
                                <li><strong>Modelo:</strong> Lenovo</li>
                                <li><strong>Procesador:</strong> Intel Core i5-1235U</li>
                                <li><strong>Tamaño de pantalla:</strong> 15.6 Pulgadas</li>
                                <li><strong>Almacenamiento:</strong> SSD de 1 TB</li>
                                <li><strong>Memoria RAM:</strong> 16 GB</li>
                                <li><strong>Color:</strong> Azul</li>
                                <li><strong>Sistema operativo:</strong> Windows 11</li>
                                <li><strong>Descripción de la tarjeta gráfica:</strong> Gráficos Intel Iris Xe</li>
                            </ul>
                        </div>
                        ...
                        <form class="cart" id="productForm" action="#" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                $precio_por_producto = 589; // Precio por cada producto
                                $ruta_img = '../assets/img/productos/Lenovo_FN-1-300x300.png'; // Ruta de la imagen del producto
                                $producto = 'Lenovo Newest Ideapad 3i'; // Nombre del producto
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="tab-content" id="product-tabs-content">
                            <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                                <h2>Descripción</h2>
                                <ul>
                                    <li>Nuevos procesadores: Intel Core i5-1235U, 2 núcleos P con Hyper-Threading, 8 núcleos E, total 12 hilos, hasta 4.4 GHz, caché de 12 MB. La última generación de rendimiento del procesador i5 superó significativamente el 1135G7, básicamente igual al 1165G7</li>
                                    <li>Pantalla: FHD de 14 pulgadas (1920 x 1080) IPS 300 nits antirreflejo, gráficos Intel Iris Xe, pantalla transparente con potentes gráficos centrales, es una buena opción para el entretenimiento de tu oficina.</li>
                                    <li>Actualizado a 16 GB de RAM: RAM de gran ancho de banda para ejecutar sin problemas tus juegos y aplicaciones de edición de fotos y video, así como múltiples programas y pestañas del navegador a la vez.
                                    </li>
                                    <li>Actualizado a almacenamiento de 1 TB: unidad de estado sólido rápida para un rendimiento impecable y multitarea confiable, te permite almacenar una gran cantidad de archivos, mejorando la velocidad de lectura de archivos grandes, asegurando el uso diario y la velocidad de apertura de archivos grandes, reduce el tiempo de aplicación y carga de archivos.
                                    </li>
                                    <li>Conexión múltiple: lector de huellas dactilares, WiFi 6, teclado retroiluminado. 1 USB 2.0, 1 USB 3.2 Gen 1, 1 USB-C 3.2 Gen 1 (compatible con transferencia de datos, Power Delivery 3.0 y DisplayPort 1.2), 1 HDMI 1.4b, 1 lector de tarjetas, 1 conector combinado de auriculares/micrófono (0.138 in), 1 conector de alimentación
                                    </li>
                                </ul>
                            </div>
    ...
    <script>
        ...
        function cargarImagenPorDefecto() {
            ...
            imagenPorDefecto.src = '../assets/img/3_productos/Lenovo_FN-1.png'; // Ruta de la imagen por defecto
            imagenPorDefecto.onload = function() {
                ctx.drawImage(imagenPorDefecto, 0, 0, canvas.width, canvas.height);
                imagenActual = '../assets/img/3_productos/Lenovo_FN-1.png'; // Actualiza la ruta de la imagen actual
            };
        }
    </script>

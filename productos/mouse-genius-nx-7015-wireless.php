...
<head>
    ...
    <title>Mouse Genius NX-7015 Wireless | Online Dc Solution</title>
            ...
            <div class="col-9">
                <nav aria-label="Breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Mouse Genius NX-7015 Wireless</li>
                    </ol>
                </nav>
                ...
                <div class="row ">
                    ...
                    <div id="rowProductoAgregado" class="row mt-3 d-none">
                        <div class="col">
                            <div class="alert alert-primary" role="alert">
                                “Mouse Genius NX-7015 Wireless” se ha añadido a tu carrito.
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/Mouse_FN.png')">
                                    <img src="../assets/img/3_productos/Mouse_FN.png" alt="Imagen 1" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/Mouse1_FN-600x602.png')">
                                    <img src="../assets/img/3_productos/Mouse1_FN-600x602.png" alt="Imagen 2" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/Mouse2_FN-600x599.png')">
                                    <img src="../assets/img/3_productos/Mouse2_FN-600x599.png" alt="Imagen 3" class="img-fluid">
                                </div>
                            </div>
                        </div> <!--row-->
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <h1 class="product-title">Mouse Genius NX-7015 Wireless
                        </h1>
                        <p class="price" style="color: #2EA3F2; font-size: 32px;">$8,00</p>
                        <div class="product-description" style="color: #666;">
                            <ul>
                                <li><strong>Modelo:</strong>Mouse Genius NX-7015 Wireless
                                </li>
                                <li><strong>Frecuencia:</strong> RF 2.4 GHz</li>
                                <li><strong>Unidad de sensor::</strong> BlueEye</li>
                                <li><strong>Resolución (DPI):</strong>1200 (SmartGenius: 800, 1200, 1600)</li>
                                <li><strong>Cantidad de botones::</strong> Tres (izquierda, derecha y central con desplazamiento)</li>
                                <li><strong>Peso (g):</strong> Aprox. 57 g（incluye receptor）</li>
                                <li><strong>Dimensiones:</strong> (A x A x P) 58 x 100 x 38,5 mm (2,28 x 3,94 x 1,52 pulgadas)</li>
                            </ul>
                        </div>
                        ...
                        <form class="cart" id="productForm" action="#" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                $precio_por_producto = 8; // Precio por cada producto
                                $ruta_img = '../assets/img/productos/Mouse_FN-300x300.png'; // Ruta de la imagen del producto
                                $producto = 'Mouse Genius NX-7015 Wireless'; // Nombre del producto
                                $marca = 'Genius'; // Marca del producto
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="tab-content" id="product-tabs-content">
                            <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                                ...
                                <ul>
                                    <li>
                                        El hardware del producto y el firmware vienen preconfigurados de fábrica. Puedes ajustar la configuración de acuerdo a tus necesidades.
                                    </li>
                                    <li>Para una actualización de firmware, puedes consultar nuestro sitio web.
                                    </li>
                                    <li>Compatible con sistema operativo Windows® 7, 8, 8.1, 10
                                    </li>
                                    <li>Mac OS X 10.8 o superior
                                    </li>
                                    <li>Colores Gris, chocolate, dorado, marrón, plateado
                                    </li>
                                    <li>Contenido de la caja NX-7015
                                    </li>
                                    <li>Mini receptor USB
                                    </li>
                                    <li>Batería alcalina AA
                                    </li>
                                    <li>Manual del usuario en varios idiomas
                                    </li>
                                </ul>
                            </div>

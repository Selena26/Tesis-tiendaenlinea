...
<head>
    ...
    <title>AMD Ryzen™ 5 5500 6-Core  | Online Dc Solution</title>
            ...
            <div class="col-9">
                <nav aria-label="Breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">AMD Ryzen™ 5 5500 6-Core</li>
                    </ol>
                </nav>
                ...
                <div class="row ">
                    ...
                    <div id="rowProductoAgregado" class="row mt-3 d-none">
                        <div class="col">
                            <div class="alert alert-primary" role="alert">
                                “AMD Ryzen™ 5 5500 6-Core” se ha añadido a tu carrito.
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/amd-555006.png')">
                                    <img src="../assets/img/3_productos/amd-555006.png" alt="Imagen 1" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/amd-555006--600x584.png')">
                                    <img src="../assets/img/3_productos/amd-555006--600x584.png" alt="Imagen 2" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/amd-555006-1-1-600x600.png')">
                                    <img src="../assets/img/3_productos/amd-555006-1-1-600x600.png" alt="Imagen 3" class="img-fluid">
                                </div>
                            </div>
                        </div> <!--row-->
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <h1 class="product-title">AMD Ryzen™ 5 5500 6-Core</h1>
                        <p class="price" style="color: #2EA3F2; font-size: 32px;">$98,41</p>
                        <div class="product-description" style="color: #666;">
                            <ul>
                            <li><strong>Marca:</strong> AMD</li>
                                <li><strong>Modelo de CPU:</strong>Ryzen 5</li>
                                ...
                                <li><strong>Número de procesadores:</strong> 6</li>
                                <li><strong>Fabricante de CPU:</strong> AMD</li>
                                <li><strong>Velocidad de la CPU:</strong> 4,2 GHz</li>
                                <li><strong>Zócalo de la CPU:</strong> Enchufe AM4</li>
                                <li><strong>Serie :</strong> AMD Ryzen 5 5500 con enfriador Wraith Stealth</li>
                                <li><strong>Número de modelo del artículo:</strong>AMD Ryzen 5 5500</li>
                            </ul>
                        </div>
                        ...
                        <form class="cart" id="productForm" action="#" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                $precio_por_producto = 98.41; // Precio por cada producto
                                $ruta_img = '../assets/img/productos/amd-555006-300x300.png'; // Ruta de la imagen del producto
                                $producto = 'AMD Ryzen™ 5 5500 6-Core'; // Nombre del producto
                                $marca = 'Ryzen'; // Marca del producto
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="tab-content" id="product-tabs-content">
                            <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                                <h2>Descripción</h2>
                                <p>El procesador de 6 núcleos más rápido de AMD para computadoras de escritorio convencionales, con 12 subprocesos de procesamiento</p>
                                <p>Puede ofrecer un rendimiento de élite de más de 100 FPS en los juegos más populares del mundo.</p>
                                <p>Incluye el silencioso y potente refrigerador AMD Wraith Stealth. Tipo de memoria del sistema: DDR4</p>
                                <p>4,6 GHz Max Boost, desbloqueado para overclocking, 35 MB de caché, soporte DDR-3200
</p>
<p>Para la plataforma avanzada Socket AM4, puede admitir PCIe 4.0 en placas base X570 y B550. Compatibilidad con sistemas operativos: Windows 11 - Edición de 64 bits, Windows 10 - Edición de 64 bits, RHEL x86 de 64 bits, Ubuntu x86 de 64 bits
    ...
    <script>
        ...
        function cargarImagenPorDefecto() {
            ...
            imagenPorDefecto.src = '../assets/img/3_productos/amd-555006.png'; // Ruta de la imagen por defecto
            imagenPorDefecto.onload = function() {
                ctx.drawImage(imagenPorDefecto, 0, 0, canvas.width, canvas.height);
                imagenActual = '../assets/img/3_productos/amd-555006.png'; // Actualiza la ruta de la imagen actual
            };
        }
    </script>

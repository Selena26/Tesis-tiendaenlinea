                    ...
                    <div class="col-md-12">
                        ...
                        <div class="tab-content" id="product-tabs-content">
                            <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                                <h2>Descripción</h2>
                                <ul>
                                    <li>Diseñada para una impresión de gran volumen
</li>
                                    <li>Imprima hasta 8000 páginas con un juego de botellas HP a color o hasta 6000 páginas con una botella HP de tinta negra.
</li>

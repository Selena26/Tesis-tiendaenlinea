...
<head>
    ...
    <title>HP Ink Tank Wireless 415 | Online Dc Solution</title>
...
<body style="background-color: #f6f7fb" onload="cargarImagenPorDefecto()">
            ...
            <div class="col-9">
                <nav aria-label="Breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="../categoria-producto/impresoras.html" style="text-decoration: none; color: #666;">Impresoras</a></li>
                        <li class="breadcrumb-item active" aria-current="page">HP Ink Tank Wireless 415</li>
                    </ol>
                </nav>
                ...
                <div class="row ">
                    ...
                    <div id="rowProductoAgregado" class="row mt-3 d-none">
                        <div class="col">
                            <div class="alert alert-primary" role="alert">
                                “HP Ink Tank Wireless 415” se ha añadido a tu carrito.
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/ImpresoraHP-Photoroom.png-Photoroom.png')">
                                    <img src="../assets/img/3_productos/ImpresoraHP-Photoroom.png-Photoroom.png" alt="Imagen 1" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/ImpresoraHP1-Photoroom.png-Photoroom-600x600.png')">
                                    <img src="../assets/img/3_productos/ImpresoraHP1-Photoroom.png-Photoroom-600x600.png" alt="Imagen 2" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/ImpresoraHP2-Photoroom.png-Photoroom-600x600.png')">
                                    <img src="../assets/img/3_productos/ImpresoraHP2-Photoroom.png-Photoroom-600x600.png" alt="Imagen 3" class="img-fluid">
                                </div>
                            </div>
                        </div> <!--row-->
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <h1 class="product-title">HP Ink Tank Wireless 415</h1>
                        <p class="price" style="color: #2EA3F2; font-size: 32px;">$170,00</p>
                        <div class="product-description" style="color: #666;">
                            <ul>
                                <li><strong>Funciones:</strong> Imprima, copie, escanee, de manera inalámbrica</li>
                                <li><strong>Conectividad:</strong> WIFI</li>
                                <li><strong>Inyección de tinta:</strong> SI</li>
                                <li><strong>Velocidad de impresión:</strong> Velocidad de impresión de hasta 8 ppm (negro) y 5 ppm (color)</li>
                                <li><strong>Calidad de impresión en negro (óptima):</strong> Hasta 1.200 x 1.200 ppp de reproducción</li>
                                <li><strong>Capacidad del alimentador automático de documentos: </strong> No</li>
                        ...
                        <form class="cart" id="productForm" action="#" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                $precio_por_producto = 170; // Precio por cada producto
                                $ruta_img = '../assets/img/productos/ImpresoraHP-Photoroom.png-Photoroom-300x300.png'; // Ruta de la imagen del producto
                                $producto = 'HP Ink Tank Wireless 415'; // Nombre del producto
                        ...
                        <div class="product-meta">
                            <span>Categoría: <a href="../categoria-producto/impresoras.html" class="text-primary" style="text-decoration: none;">Impresoras</a></span>
                        </div>
                    </div>
                </div> <!--row-->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="tab-content" id="product-tabs-content">
                            <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                                <h2>Descripción</h2>
                                <ul>
                                    <li>Diseñada para una impresión de gran volumen</li>
                                    <li>Imprima hasta 8000 páginas con un juego de botellas HP a color o hasta 6000 páginas con una botella HP de tinta negra.</li>
                                    <li>Le brinda más páginas por su dinero
                                    <li>Imprima grandes volúmenes con un costo por página extremadamente bajo gracias a este sistema de tanque de tinta de alta capacidad. <br>
                                    La potencia de su impresora en la palma de la mano</li>

                                    <li>Imprima documentos, escanee mientras viaja y solicite fácilmente consumibles desde su dispositivo móvil gracias a la aplicación HP Smart.
                                    <br> Sistema de tanque de tinta de gran capacidad</li>
                                    <li>Imprima miles de páginas con los tanques de tinta de gran capacidad: basta agregar más tinta cuando se esté agotando.</li>
                                </ul>
                            </div>
    ...
    <script>
        ...
        function cargarImagenPorDefecto() {
            ...
            imagenPorDefecto.src = '../assets/img/3_productos/ImpresoraHP-Photoroom.png-Photoroom.png'; // Ruta de la imagen por defecto
            imagenPorDefecto.onload = function() {
                ctx.drawImage(imagenPorDefecto, 0, 0, canvas.width, canvas.height);
                imagenActual = '../assets/img/3_productos/ImpresoraHP-Photoroom.png-Photoroom.png'; // Actualiza la ruta de la imagen actual
            };
        }
    </script>

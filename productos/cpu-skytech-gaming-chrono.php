...
<head>
    ...
    <title>CPU Skytech Gaming Chronos | Online Dc Solution</title>
...
<body style="background-color: #f6f7fb" onload="cargarImagenPorDefecto()">
            ...
            <div class="col-9">
                <nav aria-label="Breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="../categoria-producto/equipos-gaming.html" style="text-decoration: none; color: #666;">Equipos Gamming</a></li>
                        <li class="breadcrumb-item active" aria-current="page">CPU Skytech Gaming Chronos</li>
                    </ol>
                </nav>
                ...
                <div class="row ">
                    ...
                    <div id="rowProductoAgregado" class="row mt-3 d-none">
                        <div class="col">
                            <div class="alert alert-primary" role="alert">
                                “CPU Skytech Gaming Chronos” se ha añadido a tu carrito.
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/CPU_FN.png')">
                                    <img src="../assets/img/3_productos/CPU_FN.png" alt="Imagen 1" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/CPU2_FN-600x601.png')">
                                    <img src="../assets/img/3_productos/CPU2_FN-600x601.png" alt="Imagen 2" class="img-fluid">
                                </div>
                            </div>
                            <!-- <div class="col-md-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <h1 class="product-title">Skytech Gaming Chronos</h1>
                        <p class="price" style="color: #2EA3F2; font-size: 32px;">$680,00</p>
                        <div class="product-description" style="color: #666;">
                            <ul>
                                <li><strong>Marca:</strong> Skytech Gaming Chronos</li>
                                <li><strong>Modelo:</strong> Skytech Gaming</li>
                                <li><strong>Procesador:</strong>Intel Core i3 10105F</li>
                                <li><strong>Almacenamiento:</strong> SSD de 500 GB</li>
                                <li><strong>Memoria RAM:</strong> 16 GB</li>
                                <li><strong>Color:</strong> Negro</li>
                                <li><strong>Sistema operativo:</strong> Windows 11 Pro</li>
                                <li><strong>Descripción de la tarjeta gráfica:</strong> NVIDIA Geforce GTX 1650 4GB GDDR6</li>
                            </ul>
                        </div>
                        ...
                        <form class="cart" id="productForm" action="#" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                $precio_por_producto = 680; // Precio por cada producto
                                $ruta_img = '../assets/img/productos/CPU_FN-300x300.png'; // Ruta de la imagen del producto
                                $producto = 'Skytech Gaming Chronos'; // Nombre del producto
                                $marca = 'Skytech'; // Marca del producto
                        ...
                        <div class="product-meta">
                            <span>Categoría: <a href="../categoria-producto/equipos-gaming.html" class="text-primary" style="text-decoration: none;">Equipos Gamming</a></span>
                        </div>
                    </div>
                </div> <!--row-->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="tab-content" id="product-tabs-content">
                            <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                                <h2>Descripción</h2>
                                <ul>
                                    <li>Procesador de CPU INTEL Core i3 10105F 3.7GHz (4.4GHz Max Boost) | SSD de 500 GB, hasta 30 veces más rápido que el disco duro tradicional </li>
                                    <li>Tarjeta gráfica NVIDIA Geforce GTX 1650 4GB GDDR6 (la marca puede variar) | Memoria para juegos DDR4 RAM 3200 de 16 GB con disipador de calor | Windows 11 Home de 64 bits</li>
                                    <li>802.11 AC | Sin Bloatware | Las opciones de salida gráfica incluyen 1 x HDMI y 1 puerto de pantalla garantizado, los puertos adicionales pueden variar | Puertos USB incluyendo puertos 2.0, 3.0 y 3.2 Gen1 | Audio HD y micrófono | Teclado y mouse para juegos gratis</li>
                                    <li>4 ventiladores RGB para un máximo rendimiento de refrigeración | Skytech Chronos Mini Gaming Case con malla frontal - Edición negra | 1 año de garantía en piezas y mano de obra | Soporte técnico gratuito de por vida | Ensamblado en los Estados Unidos</li>
                                    <li>Este potente PC para juegos es capaz de ejecutar todos tus juegos favoritos como Call of Duty Warzone, Fornite, Escape from Tarkov, Grand Theft Auto V, Valorant, World of Warcraft, League of Legends, Apex Legends, Roblox, PLAYERUNKNOWN's Battlegrounds, Overwatch, Counter-Strike: Global Offensive, Battlefield V, New World, Minecraft, Elden R. ing, Liga de Cohetes e, The Division 2 y más en la configuración Ultra, resolución detallada de 1080p Full HD y un juego fluido de 60+ FPS.</li>
                                </ul>
                            </div>
    ...
    <script>
        ...
        function cargarImagenPorDefecto() {
            ...
            imagenPorDefecto.src = '../assets/img/3_productos/CPU_FN.png'; // Ruta de la imagen por defecto
            imagenPorDefecto.onload = function() {
                ctx.drawImage(imagenPorDefecto, 0, 0, canvas.width, canvas.height);
                imagenActual = '../assets/img/3_productos/CPU_FN.png'; // Actualiza la ruta de la imagen actual
            };
        }
    </script>

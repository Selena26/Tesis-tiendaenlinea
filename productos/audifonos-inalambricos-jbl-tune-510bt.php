...
<head>
    ...
    <title>Audífonos inalámbricos JBL Tune 510BT | Online Dc Solution</title>
...
<body style="background-color: #f6f7fb" onload="cargarImagenPorDefecto()">
            ...
            <div class="col-9">
                <nav aria-label="Breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Audífonos inalámbricos JBL Tune 510BT</li>
                    </ol>
                </nav>
                ...
                <div class="row ">
                    ...
                    <div id="rowProductoAgregado" class="row mt-3 d-none">
                        <div class="col">
                            <div class="alert alert-primary" role="alert">
                                “Audífonos inalámbricos JBL Tune 510BT” se ha añadido a tu carrito.
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/JBL-Photoroom.png-Photoroom.png')">
                                    <img src="../assets/img/3_productos/JBL-Photoroom.png-Photoroom.png" alt="Imagen 1" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/JBL1-Photoroom.png-Photoroom-600x599.png')">
                                    <img src="../assets/img/3_productos/JBL1-Photoroom.png-Photoroom-600x599.png" alt="Imagen 2" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/JBL2-Photoroom.png-Photoroom-600x600.png')">
                                    <img src="../assets/img/3_productos/JBL2-Photoroom.png-Photoroom-600x600.png" alt="Imagen 3" class="img-fluid">
                                </div>
                            </div>
                        </div> <!--row-->
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <h1 class="product-title">Audífonos inalámbricos JBL Tune 510BT</h1>
                        <p class="price" style="color: #2EA3F2; font-size: 32px;">$40,00</p>
                        <div class="product-description" style="color: #666;">
                            <ul>
                                <li><strong>Marca:</strong> Acer</li>
                                <li><strong>Modelo:</strong>Tune 510BT</li>
                                <li><strong>Color:</strong> Negro</li>
                                <li><strong>Factor de forma:</strong> Sobre la Oreja</li>
                                <li><strong>Tecnología de conectividad:</strong> Bluetooth 5.0</li>
                            </ul>
                        </div>
                        ...
                        <form class="cart" id="productForm" action="#" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                $precio_por_producto = 40; // Precio por cada producto
                                $ruta_img = '../assets/img/productos/JBL-Photoroom.png-Photoroom-300x300.png'; // Ruta de la imagen del producto
                                $producto = 'Audífonos inalámbricos JBL Tune 510BT'; // Nombre del producto
                                $marca = 'JBL'; // Marca del producto
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="tab-content" id="product-tabs-content">
                            <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                                <h2>Descripción</h2>
                                <ul>
                                    <li>Los audífonos inalámbricos Tune 510BT destacan por su reconocido sonido JBL Pure Bass, que se puede encontrar en los eventos más famosos de todo el mundo.</li>
                                    <li>Con Bluetooth 5.0 para transmisión inalámbrica; puedes transmitir de forma inalámbrica desde tu dispositivo e incluso cambiar entre dos dispositivos para no perderte una llamada.</li>
                                    <li>Para una diversión duradera: escucha de forma inalámbrica hasta un máximo de 40 horas y recarga la batería en tan solo 2 horas con el práctico cable USB tipo C. Una rápida recarga de 5 minutos te da 2 horas adicionales de música.</li>
                                    <li>Controla fácilmente tu sonido y gestiona tus llamadas desde tus audífonos con los prácticos botones del audífono.
                                    </li>
                                    <li>Tendrás Siri o Hey Google con solo apretar un botón: activa el asistente de voz de tu dispositivo presionando el botón multifunción.</li>
                                </ul>
                            </div>
    ...
    <script>
        ...
        function cargarImagenPorDefecto() {
            ...
            imagenPorDefecto.src = '../assets/img/3_productos/JBL-Photoroom.png-Photoroom.png'; // Ruta de la imagen por defecto
            imagenPorDefecto.onload = function() {
                ctx.drawImage(imagenPorDefecto, 0, 0, canvas.width, canvas.height);
                imagenActual = '../assets/img/3_productos/JBL-Photoroom.png-Photoroom.png'; // Actualiza la ruta de la imagen actual
            };
        }
    </script>

...
<head>
    ...
    <title>Epson L4160 Multifuncional | Online Dc Solution</title>
...
<body style="background-color: #f6f7fb" onload="cargarImagenPorDefecto()">
            ...
            <div class="col-9">
                <nav aria-label="Breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Epson L4160 Multifuncional</li>
                    </ol>
                </nav>
                ...
                <div class="row ">
                    ...
                    <div id="rowProductoAgregado" class="row mt-3 d-none">
                        <div class="col">
                            <div class="alert alert-primary" role="alert">
                                “Epson L4160 Multifuncional” se ha añadido a tu carrito.
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/L4160.png')">
                                    <img src="../assets/img/3_productos/L4160.png" alt="Imagen 1" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/L41601.png')">
                                    <img src="../assets/img/3_productos/L41601.png" alt="Imagen 2" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/L41602-600x598.png')">
                                    <img src="../assets/img/3_productos/L41602-600x598.png" alt="Imagen 3" class="img-fluid">
                                </div>
                            </div>
                        </div> <!--row-->
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <h1 class="product-title">Epson L4160 Multifuncional</h1>
                        <p class="price" style="color: #2EA3F2; font-size: 32px;">$255,00</p>
                        <div class="product-description" style="color: #666;">
                            <ul>
                                <li>Imprime hasta 7.500 páginas en negro y 6.000 páginas a color</li>
                                <li>Ahorra hasta el 90 por ciento en la tinta con las botellas de reemplazo de bajo costo</li>
                                <li>Nuevo diseño de relleno de botellas con llenado automático, codificadas de manera única para el llenado fácil de cada color</li>
                                <li>Impresión inalámbrica/con Wi-Fi Direct desde tabletas/teléfonos inteligentes</li>
                                <li>Garantía limitada  de dos años con el registro
</li>
                            </ul>
                        </div>
                        ...
                        <form class="cart" id="productForm" action="#" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                $precio_por_producto = 255; // Precio por cada producto
                                $ruta_img = '../assets/img/productos/L4160-300x300.png'; // Ruta de la imagen del producto
                                $producto = 'Epson L4160 Multifuncional'; // Nombre del producto
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="tab-content" id="product-tabs-content">
                            <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                                <h2>Descripción</h2>
                                <p>
                                La multifuncional inalámbrica EcoTank L4160 te ofrece la revolucionaria impresión sin cartuchos, con nuevo diseño de tanques frontales, botellas de tinta con llenado automático y codi_cadas para llenado fácil de cada color. Además, la EcoTank L4160 te permite imprimir hasta 7.500 páginas en negro o 6.000 páginas a color. Imprime cientos de proyectos sin interrupciones, con los juegos de botellas de tinta original Epson que equivalen a unos 35 juegos de cartuchos de tinta, ahorrando hasta 90 % en tinta con las botellas de reemplazo de bajo costo. La EcoTank L4160 también permite imprimir en forma inalámbrica desde tabletas y teléfonos inteligentes y tiene Wi-Fi Direct™ e impresión automática a doble cara. 
                                </p>
                            </div>
    ...
    <script>
        ...
        function cargarImagenPorDefecto() {
            ...
            imagenPorDefecto.src = '../assets/img/3_productos/L4160.png'; // Ruta de la imagen por defecto
            imagenPorDefecto.onload = function() {
                ctx.drawImage(imagenPorDefecto, 0, 0, canvas.width, canvas.height);
                imagenActual = '../assets/img/3_productos/L4160.png'; // Actualiza la ruta de la imagen actual
            };
        }
    </script>

...
<head>
    ...
    <title>ASUS TUF Dash F15 | Online Dc Solution</title>
...
<body style="background-color: #f6f7fb" onload="cargarImagenPorDefecto()">
            ...
            <div class="col-9">
                <nav aria-label="Breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">ASUS TUF Dash F15</li>
                    </ol>
                </nav>
                ...
                <div class="row ">
                    ...
                    <div id="rowProductoAgregado" class="row mt-3 d-none">
                        <div class="col">
                            <div class="alert alert-primary" role="alert">
                                “ASUS TUF Dash F15” se ha añadido a tu carrito.
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/Laptop_Asus_tuf15rm-e1704333372448.png')">
                                    <img src="../assets/img/3_productos/Laptop_Asus_tuf15rm-e1704333372448.png" alt="Imagen 1" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/Laptop_Asus_tuf151rm-600x600.png')">
                                    <img src="../assets/img/3_productos/Laptop_Asus_tuf151rm-600x600.png" alt="Imagen 2" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/Laptop_Asus_tuf152rm-600x600.png')">
                                    <img src="../assets/img/3_productos/Laptop_Asus_tuf152rm-600x600.png" alt="Imagen 3" class="img-fluid">
                                </div>
                            </div>
                        </div> <!--row-->
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <h1 class="product-title">ASUS TUF Dash F15
</h1>
                        <p class="price" style="color: #2EA3F2; font-size: 32px;">$1.109,00</p>
                        <div class="product-description" style="color: #666;">
                        <ul>
                                <li><strong>Marca:</strong> ASUS</li>
                                <li><strong>Modelo:</strong> TUF Dash 15 (2022)</li>
                                <li><strong>Procesador:</strong> Intel Core i7-12650H</li>
                                <li><strong>Tamaño de pantalla:</strong> 15,6 Pulgadas</li>
                                <li><strong>Almacenamiento:</strong> 512 GB SSD PCIe NVMe M.2/li>
                                <li><strong>Memoria RAM:</strong> 16 GB</li>
                                <li><strong>Color:</strong> Negro Sucio</li>
                                <li><strong>Sistema operativo:</strong> Windows 11 Home</li>
                                <li><strong>Descripción de la tarjeta gráfica:</strong> RTX 3060</li>
                            </ul>
                        </div>
                        ...
                        <form class="cart" id="productForm" action="#" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                $precio_por_producto = 1109; // Precio por cada producto
                                $ruta_img = '../assets/img/productos/Laptop_Asus_tuf15rm-e1704333372448-300x300.png'; // Ruta de la imagen del producto
                                $producto = 'ASUS TUF Dash F15'; // Nombre del producto
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="tab-content" id="product-tabs-content">
                            <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                                <h2>Descripción</h2>
                                <ul>
                                    <li>Gráficos RTX supercargados: los gráficos de juego son suaves como la seda con la NVIDIA GeForce RTX 3060 6GB GDDR6 a 1050 W con impulso dinámico, con funciones de IA de vanguardia como NVIDIA DLSS y Ray-Tracing. Voltaje: 20.0 voltios. Tecnología de conectividad: Bluetooth 5.2</li>
                                    <li>Listo para cualquier cosa: utiliza tu laptop de juegos para transmitir y realizar múltiples tareas con facilidad gracias a un procesador Intel Core i7-12650H con caché de 24 MB, hasta 4.7 GHz, 10 núcleos (6 núcleos P y 4 núcleos E) y 16 GB de RAM DDR5 de 4800 MHz increíblemente rápida en Windows 11.
                                    </li>
                                    <li>Visuales Swift: manténgase un paso por delante de la competencia gracias a su pantalla IPS Full HD de 144Hz 15.6" (1920 x 1080) tipo IPS</li>
                                    <li>Amplio almacenamiento para todos tus juegos: almacena toda tu biblioteca de juegos y cárgalos rápidamente en tu SSD PCIe NVMe M.2 de 512 GB para aprovechar la experiencia completa de juego RTX.</li>
                                    <li>Mantente fresco: ventiladores dobles de flujo de arco autolimpiante con tecnología antipolvo que prolongan la longevidad del sistema.</li>
                                </ul>
                            </div>
    ...
    <script>
        ...
        function cargarImagenPorDefecto() {
            ...
            imagenPorDefecto.src = '../assets/img/3_productos/Laptop_Asus_tuf15rm-e1704333372448.png'; // Ruta de la imagen por defecto
            imagenPorDefecto.onload = function() {
                ctx.drawImage(imagenPorDefecto, 0, 0, canvas.width, canvas.height);
                imagenActual = '../assets/img/3_productos/Laptop_Asus_tuf15rm-e1704333372448.png'; // Actualiza la ruta de la imagen actual
            };
        }
    </script>

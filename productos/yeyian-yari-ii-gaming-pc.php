...
<head>
    ...
    <title>YEYIAN Yari II Gaming PC| Online Dc Solution</title>
...
<body style="background-color: #f6f7fb" onload="cargarImagenPorDefecto()">
            ...
            <div class="col-9">
                <nav aria-label="Breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">YEYIAN Yari II Gaming PC</li>
                    </ol>
                </nav>
                ...
                <div class="row ">
                    ...
                    <div id="rowProductoAgregado" class="row mt-3 d-none">
                        <div class="col">
                            <div class="alert alert-primary" role="alert">
                                “YEYIAN Yari II Gaming PC” se ha añadido a tu carrito.
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/CPUGN2_FN (1).png')">
                                    <img src="../assets/img/3_productos/CPUGN2_FN (1).png" alt="Imagen 1" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/CPUGN_FN-600x599.png')">
                                    <img src="../assets/img/3_productos/CPUGN_FN-600x599.png" alt="Imagen 2" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/CPUGN3_FN-600x599.png')">
                                    <img src="../assets/img/3_productos/CPUGN3_FN-600x599.png" alt="Imagen 3" class="img-fluid">
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <h1 class="product-title">YEYIAN Yari II Gaming PC</h1>
                        <p class="price" style="color: #2EA3F2; font-size: 32px;">$1.550,00

</p>
                        <div class="product-description" style="color: #666;">
                            <ul>
                                <li><strong>Marca:</strong> YEYIAN</li>
                                <li><strong>Modelo:</strong> Yari II</li>
                                <li><strong>Procesador:</strong> Intel Core i7 13700F</li>
                                <li><strong>Almacenamiento:</strong>SSD NVMe de 1 TB</li>
                                <li><strong>Memoria RAM:</strong> 16 GB</li>
                                <li><strong>Color:</strong> Negro</li>
                                <li><strong>Sistema operativo:</strong> Windows 11 Home</li>
                                <li><strong>Componentes incluidos: </strong> Mouse, Iluminación RGB, Teclado</li>
                                <li><strong>Descripción de la tarjeta gráfica:</strong> Nvidia Geforce RTX 4070 12GB GDDR6X</li>
                            </ul>
                        </div>
                        <p class="stock in-stock" style="color: #b3af54;">8 disponibles</p>
                        <form class="cart" id="productForm" action="#" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                $precio_por_producto = 1550; // Precio por cada producto
                                $ruta_img = '../assets/img/productos/CPUGN2_FN-300x300.png'; // Ruta de la imagen del producto
                                $producto = 'YEYIAN Yari II Gaming PC'; // Nombre del producto
                                $marca = 'YEYIAN'; // Marca del producto
                        ...
                        <div class="product-meta">
                            <span>Categoría: <a href="../categoria-producto/accesorios-gaming.html" class="text-primary" style="text-decoration: none;">Accesorios Gaming</a></span>
                        </div>
                    </div>
                </div> <!--row-->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="tab-content" id="product-tabs-content">
                            <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                                <h2>Descripción</h2>
                                <ul>
                                    <li>Sistema: CPU Intel i7-13700F 16 núcleos 24 hilos 5.20 GHz | placa base Intel B660 | Ventiladores de refrigeración AIO de 9.449 in | PC para juegos preconstruida con Windows 11 Home</li>        
                                    <li>GRÁFICOS Y MEMORIA: Nvidia Geforce RTX 4070 12GB GDDR6X 21 Gbps 192 bit Tarjeta gráfica PC para juegos | Memoria DDR4 de 16 GB de 3200 MHz | SSD NVMe de 1 TB</li>
                                    <li>FUNDA Y POTENCIA: Carcasa para computadora de juegos YEYIAN Arc | 6 ventiladores de anillo ajustables de color del sistema ARGB | Fuente de alimentación certificada Oro de 650 W | Tamaño de la caja 22 x 12 x 21 pulgadas</li>
                                    <li>CONECTIVIDAD: Frontal:1x USB 3.1 TYPE-C, 2x USB 3.0 HD-Audio & Mic, Trasero: 2 x USB 3.2 Gen 2x2 Puertos (1 x USB Tipo-C) 2 x Puertos USB 3.2 Gen 2 (2 x Tipo-A) 5 x Puertos USB 3.2 Gen 1 (4 x Tipo-A + 1 x USB Tipo-C) 1 x DisplayPort 1 x puerto HDMI 1 x ASUS Wi-Fi Módulo 1 x Intel 2.5Gb Ethernet puerto 5 x conectores de audio 1 x puerto de salida óptica S/PDIF</li>
    ...
    <script>
        ...
        function cargarImagenPorDefecto() {
            ...
            imagenPorDefecto.src = '../assets/img/3_productos/CPUGN2_FN (1).png'; // Ruta de la imagen por defecto
            imagenPorDefecto.onload = function() {
                ctx.drawImage(imagenPorDefecto, 0, 0, canvas.width, canvas.height);
                imagenActual = '../assets/img/3_productos/CPUGN2_FN (1).png'; // Actualiza la ruta de la imagen actual
            };
        }
    </script>

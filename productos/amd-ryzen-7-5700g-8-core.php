...
<head>
    ...
    <title>AMD Ryzen 7 5700G | Online Dc Solution</title>
                    ...
                    <div class="col-md-6">
                        ...
                        <form class="cart" id="productForm" action="#" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                $ruta_img = '../assets/img/productos/CPUAMDR75700G-3-f-300x300.png'; // Ruta de la imagen del producto
                                $producto = 'AMD Ryzen 7 5700G'; // Nombre del producto

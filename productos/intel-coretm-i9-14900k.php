...
<head>
    ...
    <title>Intel® CoreTM i9-14900K | Online Dc Solution</title>
...
<body style="background-color: #f6f7fb" onload="cargarImagenPorDefecto()">
            ...
            <div class="col-9">
                <nav aria-label="Breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Intel® CoreTM i9-14900K</li>
                    </ol>
                </nav>
                ...
                <div class="row ">
                    <div id="rowProductoAgregado" class="row mt-3 d-none">
                        <div class="col">
                            <div class="alert alert-primary" role="alert">
                                “Intel® CoreTM i9-14900K” se ha añadido a tu carrito.
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/inteli9.png')">
                                    <img src="../assets/img/3_productos/inteli9.png" alt="Imagen 1" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="thumbnail" onclick="toggleImagen('../assets/img/3_productos/corei9-f.png')">
                                    <img src="../assets/img/3_productos/corei9-f.png" alt="Imagen 2" class="img-fluid">
                                </div>
                            </div>
                            <!-- <div class="col-md-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <h1 class="product-title">Intel® CoreTM i9-14900K</h1>
                        <p class="price" style="color: #2EA3F2; font-size: 32px;">$544,99</p>
                        <div class="product-description" style="color: #666;">
                            <ul>
                                <li><strong>Marca:</strong> Intel</li>
                                <li><strong>Modelo de CPU:</strong> núcleo i9</li>
                                <li><strong>Dimensiones del producto</strong> 7 x 2,5 x 6,9 pulgadas</li>
                                <li><strong>Color:</strong>Gris Cerámica</li>
                                <li><strong>Marca del procesador:</strong> Intel</li>
                                <li><strong>Número de procesadores:</strong> 12</li>
                                <li><strong>Fabricante de CPU:</strong> Intel</li>
                                <li><strong>Velocidad de la CPU:</strong> 6 GHz</li>
                                <li><strong>Zócalo de la CPU:</strong> LGA 1700</li>
                                <li><strong>Serie:</strong> Core™ i9-14900K</li>
                                <li><strong>Número de modelo del artículo:</strong> BX8071514900K</li>
                        ...
                        <form class="cart" id="productForm" action="#" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                $precio_por_producto = 544.99; // Precio por cada producto
                                $ruta_img = '../assets/img/productos/inteli9-300x300.png'; // Ruta de la imagen del producto
                                $producto = 'Intel® CoreTM i9-14900K'; // Nombre del producto
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="tab-content" id="product-tabs-content">
                            <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                                <h2>Descripción</h2>
                                <p>
                                24 núcleos (8 núcleos P + 16 núcleos E) y 32 hilos. Gráficos Intel UHD 770 integrados incluidos
 
                                </p>
                                <p>
                                La velocidad máxima de reloj líder de hasta 6,0 GHz te ofrece un juego más fluido, mayores velocidades de fotogramas y una rápida capacidad de respuesta. 
                                </p>
                                <p>Compatible con placas base basadas en chipset Intel serie 600 (con posible actualización de BIOS) o serie 700</p>
    ...
    <script>
        ...
        function cargarImagenPorDefecto() {
            ...
            imagenPorDefecto.src = '../assets/img/3_productos/inteli9.png'; // Ruta de la imagen por defecto
            imagenPorDefecto.onload = function() {
                ctx.drawImage(imagenPorDefecto, 0, 0, canvas.width, canvas.height);
                imagenActual = '../assets/img/3_productos/inteli9.png'; // Actualiza la ruta de la imagen actual
            };
        }
    </script>

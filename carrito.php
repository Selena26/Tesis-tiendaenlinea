...
session_start();
$total = isset($_SESSION['cart_price']) ? $_SESSION['cart_price'] : 0;
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        ...
                        <a class="nav-link mx-2 active" style="color: #0d8ce0;" aria-current="page" href="index.html">INICIO</a>
                    </li>
                    ...
                    <tbody>
                        <?php if (isset($_SESSION['ruta_img']) && isset($_SESSION['producto']) && isset($_SESSION['precio_por_producto']) && isset($_SESSION['cart_quantity'])) : ?>
                            <tr>
                                <td>
                                    <form method="post">
                                        <button type="submit" name="eliminar_sesion" class="btn btn-outline-danger"><i class="bi bi-trash3-fill"></i></button>
                                    </form>
                                </td>
                                <td>
                                    <img src="<?php echo $_SESSION['ruta_img']; ?>" alt="Imagen del producto" width="100">
                                </td>
                                <td><?php echo $_SESSION['producto']; ?></td>
                                <td>$<?php echo $_SESSION['precio_por_producto']; ?></td>
                                <td>
                                    <div class="input-group">
                                        <input type="text" class="form-control" value="<?php echo $_SESSION['cart_quantity']; ?>" readonly>
                                    </div>
                                </td>
                                <td>$<?php echo $_SESSION['cart_price']; ?></td>
                            </tr>
                        <?php else : ?>
                            <tr>
        ...
        <div class="col-12">
            <div class="cart-totals calculated-shipping">
                ...
                <div class="wc-proceed-to-checkout">
                    <a href="pago.php" class="btn btn-primary checkout-button button alt wc-forward">
                        Finalizar compra
                    </a>
                </div>
            </div>
